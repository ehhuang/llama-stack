...
from llama_stack.providers.inline.files.meta_reference.config import MetaReferenceFilesImplConfig
...
def get_distribution_template() -> DistributionTemplate:
    ...
    files_provider = Provider(
        ...
        config=MetaReferenceFilesImplConfig.sample_run_config(f"~/.llama/distributions/{name}"),
    )
