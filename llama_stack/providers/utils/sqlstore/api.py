...
class SqlStore(Protocol):
    ...
    async def update(self, table: str, data: Mapping[str, Any], where: Mapping[str, Any] | None = None) -> None:
        """
        Update a row in a table.
        """
        pass

    async def delete(self, table: str, where: Mapping[str, Any] | None = None) -> None:
        """
