...
from llama_stack.providers.inline.files.meta_reference import (
    MetaReferenceFilesImpl,
    MetaReferenceFilesImplConfig,
)
...
class TestOpenAIFilesAPI:
    ...
    async def test_retrieve_file_content_success(self, files_provider, sample_text_file):
        ...
        # Verify content
        assert content == sample_text_file.content
    ...
    async def test_multiple_files_operations(self, files_provider, sample_text_file, sample_json_file):
        ...
        assert content == sample_json_file.content
