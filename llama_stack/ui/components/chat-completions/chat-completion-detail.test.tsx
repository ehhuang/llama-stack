...
describe('ChatCompletionDetailView', () => {
  test('renders skeleton UI when isLoading is true', () => {
    const { container } = render(
      <ChatCompletionDetailView completion={null} isLoading={true} error={null} id="test-id" />
    );
  ...
  test('renders error message when error prop is provided', () => {
    ...
    expect(screen.getByText(/Error loading details for ID err-id: Network Error/)).toBeInTheDocument();
  });
  ...
  test('renders default error message when error.message is empty', () => {
    ...
    expect(screen.getByText(/Error loading details for ID\s*err-id\s*:/)).toBeInTheDocument();
  });
  ...
  test('renders not found message when completion is null and not loading/error', () => {
    ...
    expect(screen.getByText('No details found for completion ID: notfound-id.')).toBeInTheDocument();
  });
  ...
  test('handles missing/empty fields gracefully', () => {
    ...
    expect(screen.getByText("No message found in assistant's choice.")).toBeInTheDocument();
