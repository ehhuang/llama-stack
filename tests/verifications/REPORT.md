...
*Generated on: 2025-04-17 10:45:59*
...
pytest tests/verifications/openai_api/test_chat_completion.py --provider=llama_meta_ref -v

# Example: Run only the 'earth' case of test_chat_non_streaming_basic:
pytest tests/verifications/openai_api/test_chat_completion.py --provider=llama_meta_ref -k "test_chat_non_streaming_basic and earth"
```


**Model Key (Llama_meta_ref)**
