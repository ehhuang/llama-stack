...
class WebMethod:
    ...
    provided_by_stack: bool | None = False
...
def webmethod(
    ...
    :param provided_by_stack: True if the method is provided by the stack, and doesn't need to be implemented by providers.
    """
    ...
    def wrap(func: T) -> T:
        func.__webmethod__ = WebMethod(  # type: ignore
            ...
            provided_by_stack=provided_by_stack,
        )
        return func
