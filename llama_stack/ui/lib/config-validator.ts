...
export function validateServerConfig() {
  if (process.env.NODE_ENV === "development") {
    ...
    if (!optionalConfigs.GITHUB_CLIENT_ID || !optionalConfigs.GITHUB_CLIENT_SECRET) {
      ...
      console.log("   2. Set Application name: Llama Stack UI (or your preferred name)");
      console.log("   3. Set Homepage URL: http://localhost:8322");
      console.log("   4. Set Authorization callback URL: http://localhost:8322/api/auth/callback/github");
      console.log("   5. Create the app and copy the Client ID and Client Secret");
