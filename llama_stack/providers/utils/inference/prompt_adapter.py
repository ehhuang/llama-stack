...
def chat_completion_request_to_messages(
    ...
    if model.model_family == ModelFamily.llama3_1 or (
        ...
        messages = augment_messages_for_tools_llama_3_2(request, PythonListCustomToolGenerator)
    elif model.model_family == ModelFamily.llama4:
        messages = augment_messages_for_tools_llama_3_2(request, PythonListCustomToolGeneratorLlama4)
    else:
