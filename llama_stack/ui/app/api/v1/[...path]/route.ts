...
// Get backend URL from environment variable or default to cluster service name
const BACKEND_URL = process.env.LLAMA_STACK_BACKEND_URL;
...
async function proxyRequest(request: NextRequest, method: string) {
  try {
    ...
    console.log(`Response from FastAPI: ${response.status} ${response.statusText}`);
