...
from llama_stack.providers.remote.inference.fireworks_compat.config import FireworksCompatConfig
...
from llama_stack.providers.remote.inference.together_compat.config import TogetherCompatConfig
