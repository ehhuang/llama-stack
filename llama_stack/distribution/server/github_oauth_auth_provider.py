...
class GitHubAuthProvider(AuthProvider):
    ...
    async def validate_token(self, token: str, scope: dict | None = None) -> User:
        ...
        try:
            ...
            # Extract principal and attributes
    ...
    async def complete_oauth_flow(self, code: str) -> dict:
        """Complete the GitHub OAuth flow and return user info with JWT."""
        ...
        return {
            ...
            "user_info": {
                "username": github_info["user"]["login"],
                "email": github_info["user"].get("email"),
                "name": github_info["user"].get("name"),
                "avatar_url": github_info["user"].get("avatar_url"),
    ...
    async def _exchange_code_for_token(self, code: str) -> Any:
