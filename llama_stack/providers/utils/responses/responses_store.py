...
class OpenAIResponseObjectWithInputAndMessages(OpenAIResponseObjectWithInput):
...
class ResponsesStore:
    ...
    async def get_response_object(self, response_id: str) -> OpenAIResponseObjectWithInputAndMessages:
        """
        ...
        return OpenAIResponseObjectWithInputAndMessages(**row["response_object"])
