...
from llama_stack.providers.inline.files.local_fs_sql.config import LocalFsSqlFilesImplConfig
...
def get_distribution_template() -> DistributionTemplate:
    ...
    files_provider = Provider(
        ...
        provider_type="inline::local-fs-sql",
        config=LocalFsSqlFilesImplConfig.sample_run_config(f"~/.llama/distributions/{name}"),
    )
