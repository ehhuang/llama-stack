...
def generate_charts(benchmark_dir: str = "results"):
    ...
    def create_charts(data_dict, prefix, title_prefix):
        ...
        for setup_name in sorted(data_dict.keys()):
            ...
            ax1.set_title("RPS vs Concurrency", fontsize=14, fontweight="bold")
            ...
            ax2.set_ylabel("Request Latency (ms)", fontsize=12)
            ax2.set_title("Request Latency vs Concurrency", fontsize=14, fontweight="bold")
            ...
            ax3.set_title("TTFT vs Concurrency", fontsize=14, fontweight="bold")
            ...
            ax4.set_ylabel("Inter Token Latency (ms)", fontsize=12)
            ax4.set_title("ITL vs Concurrency", fontsize=14, fontweight="bold")
